...
#     station_file=file.readlines()
#     print(station_file)
#     station_file.pop(0)
#     print(station_file)
#     for value in station_file:
#         station_file=value.strip("\n")
...
cities=["Seattle", "Maui", "Cincinnati", "Sandiego"]
added_cities=[]
...
for city in cities:
    ...
    for measurement in all_states:
        ...
        if measurement["city"] not in total_monthly_precipitation_all:
            total_monthly_precipitation_area={}
        ...
        yr_area += measurement["value"]
    yr_all[city]=yr_area
    print(yr_all[city])
    total_monthly_precipitation_all[city]=total_monthly_precipitation_area

        
        # if measurement["city"] not in rel_all:
        #     rel_area={}
        # if month not in rel_area:
        #     rel_area[month]=0

        # rel_area[month] += total_monthly_precipitation_area[month]/yr_all[city]
